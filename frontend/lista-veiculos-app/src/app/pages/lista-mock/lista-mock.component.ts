...
import { MockVeiculoService } from '../../services/mock-veiculo.service';

@Component({
  selector: 'app-lista-mock',
  standalone: true,
  imports: [CommonModule, HttpClientModule, ReactiveFormsModule, FormsModule, NgbPaginationModule],
  templateUrl: './lista-mock.component.html',
  styleUrls: ['./lista-mock.component.scss']
})
export class ListaMockComponent implements OnInit {
  veiculos: any[] = [];
  modelos: string[] = [];
  marcas: string[] = [];
  ...
  constructor(private veiculoService: MockVeiculoService, private fb: FormBuilder, private modalService: NgbModal) {
